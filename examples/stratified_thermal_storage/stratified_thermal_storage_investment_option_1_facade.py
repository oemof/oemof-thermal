...
optimization_model.write(
    'storage_model_invest_option_1_facades.lp',
    io_options={'symbolic_solver_labels': True}
)

with open('storage_model_invest_option_1_facades.lp') as generated_file:
    with open('storage_model_invest_option_1.lp') as expected_file:
